    ...
    public class VaccinationController:ControllerBase
    {
        ...
        public string newVaccination(Vaccination vaccination)
        {
            ...
            while (vaccination.manufacturer != "moderna" || vaccination.manufacturer != "fizer")
                return"";
            SqlCommand cmd = new SqlCommand("INSERT INTO Vaccination(id,vaccinationDate,manufacturer)VALUES('" + vaccination.id + "','" + vaccination.vaccinationDate + "','" + vaccination.manufacturer + "')", con);
