...
namespace TikshuvProject.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public string newCustomer(Customer customer)
        {
            ...
            con.Close();
            SqlCommand cmd = new SqlCommand("INSERT INTO Customer(id,firstName,lastName,phone,mobile,city,numOfStreet,Address,birthday)VALUES('" + customer.id + "','" + customer.firstName + "','" + customer.lastName + "','" + customer.phone + "','" + customer.mobile + "','" + customer.city + "','" + customer.numOfStreet + "','" + customer.address + "','" + customer.birthday + "')", con);
            con.Open();
        ...
        public IActionResult Calander()
        {
            int temp = 1;
            int s, e, j;
            int[] calander = new int[31];
            string[,] toprint = new string[31, 2];
